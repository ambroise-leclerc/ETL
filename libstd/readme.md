...
| `thread`, `vector` | Experimental | Present and exercised, but still evolving toward a clearer embedded contract and deeper validation. |
| `string`, `tuple`, `random` | Placeholder | Present in the tree, but not yet strong enough to be treated as part of the supported subset. |
